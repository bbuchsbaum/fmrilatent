...
neuroimaging data. It provides S4 classes (`LatentNeuroVec`) for
efficient storage and manipulation of dimensionality-reduced brain data.
...
AGENTS.md for full workflow.

**Key commands:** - `bd ready` - Tasks without blockers (your next
work) - `bd create "title" -p 1` - Create task with priority -
`bd close <id> --reason "text"` - Close completed task - `bd sync` -
Force sync to git
